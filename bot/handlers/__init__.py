...
from bot.handlers.market import handle_price, handle_market, handle_orderbook, handle_chart, handle_watch, handle_watchlist, handle_unwatch, handle_scan4h, handle_similar
